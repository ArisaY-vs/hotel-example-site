  ...
  '<div class="card-body">' +
    '<h5 class="card-title">' + plan.name + '</h5>' +
      '<ul class="list-unstyled">' +
        ...
        '<li>' + plan.room + '</li>' +
      '</ul>' +
      /* ' <a href="./reserve.html?plan-id=' + 100 + '" class="btn btn-primary" target="_blank" rel="opener">' + t('plans.reserveLink') + '</a>' + */
      ' <a href="./reserve.html?plan-id=' + 100 + '" class="btn btn-primary" target="_blank" rel="opener">' + test + '</a>' +
    '</div>' +
  '</div>' +
'</div>';
}
